...
public class AppinArd
{
	public static void main(String[] args) throws Exception
	{
		...
		driver.findElement(By.name("lastName")).sendKeys("kalam",Keys.TAB,"9999988845");
		driver.findElement(By.name("userName")).sendKeys("apj@abdulkalam.com");
		driver.findElement(By.name("address1")).sendKeys("Mosqe street");
		...
		driver.findElement(By.name("password")).sendKeys("batch238sixpack");
		driver.findElement(By.name("confirmPassword")).sendKeys("batch238sixpack");
