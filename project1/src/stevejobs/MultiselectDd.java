...
public class MultiselectDd {
	public static void main(String[] args) throws Exception {
		...
		List<WebElement> sil = driver
				.findElements(By.xpath("//*[contains(@class,'selection multiple upward')]/child::a"));
		System.out.println("Selected items count is " + sil.size());
		for (int i = 0; i < sil.size(); i++) {
			System.out.println(sil.get(i).getText());
		}
		Thread.sleep(5000);
		// Deselect 1st item
		driver.findElement(By.xpath("//*[contains(@class,'selection multiple upward')]/child::a[1]/child::*")).click();
		Thread.sleep(5000);
