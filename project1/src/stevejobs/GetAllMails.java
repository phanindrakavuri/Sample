...
public class GetAllMails {
	public static void main(String[] args) throws Exception {
		...
		List<WebElement> mails = driver.findElements(By.xpath("(//*[@role='tabpanel'])[1]/descendant::table/tbody/tr"));
		int urc = 0;
		int rc = 0;
		for (int i = 1; i <= mails.size(); i++) {
			WebElement e = driver.findElement(
					By.xpath("(//*[@role='tabpanel'])[1]/descendant::table/tbody/tr[" + i + "]/td[4]/div[1]"));
